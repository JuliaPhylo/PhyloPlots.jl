@testset "Test setup for plotting PhyloNetworks objects" begin
  ...
  # xmin, xmax, ymin, ymax
  @test PhyloPlots.edgenode_coordinates(net, true, false, :none) == (
  ...
  @test PhyloPlots.edgenode_coordinates(net, true, true, :none, false) == (
    [0.0, 1.5, 1.5, 0.5, 1.5, 2.0, 1.5, 0.5, 0.0],
  ...
  @test PhyloPlots.edgenode_coordinates(net, false, true, :none, false) == (
